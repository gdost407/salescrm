<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="index.html" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bolder ms-2">ANIKET</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ request()->routeIs('integration-*') ? 'active open' : '' }}">
      ...
      <ul class="menu-sub">
        <li class="menu-item {{ request()->routeIs('integration-api-token') ? 'active' : '' }}">
          <a href="{{ route('integration-api-token') }}" class="menu-link">
            <div data-i18n="Account">API Token</div>
          </a>
        </li>
        <li class="menu-item {{ request()->routeIs('integration-google-sheet') ? 'active' : '' }}">
          <a href="{{ route('integration-google-sheet') }}" class="menu-link">
