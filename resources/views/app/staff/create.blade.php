    ...
    <div class="card-body">
      <form action="{{ route('staff.store') }}" method="POST">
        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="mb-6">
              <label class="form-label" for="basic-icon-default-fullname">Job Role</label>
              <div class="input-group input-group-merge">
                <span id="basic-icon-default-fullname2" class="input-group-text text-danger"><i class="icon-base bx bx-pin"></i></span>
          ...
          <div class="col-sm-3">
            <div class="mb-6">
              ...
              <div class="input-group input-group-merge">
                ...
                <select name="role_id" class="form-select" id="role_id" aria-label="CRM role access" @disabled(! auth()->user()->hasPermission('manage_roles'))>
