...
new class extends Component {
    ...
    public function saveStaff()
    {
        ...
        // Save the staff member (implement your logic here)
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <form wire:submit="saveStaff">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="firstName" class="form-label">First Name *</label>
                                <input type="text" class="form-control" id="firstName" wire:model="firstName" placeholder="John">
                                @error('firstName') <span class="text-danger small">{{ $message }}</span> @enderror
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="lastName" class="form-label">Last Name *</label>
                                <input type="text" class="form-control" id="lastName" wire:model="lastName" placeholder="Doe">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email" wire:model="email" placeholder="john.doe@example.com">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="department" wire:model="department" placeholder="Sales, Marketing, etc.">
