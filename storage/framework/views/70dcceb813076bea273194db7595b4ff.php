<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item <?php echo e(request()->routeIs('calendar') ? 'active' : ''); ?>">
      <a href="<?php echo e(route('calendar')); ?>" class="menu-link">
...
</aside><?php /**PATH P:\xampp\htdocs\GDost\salescrm\resources\views/partials/aside.blade.php ENDPATH**/ ?>